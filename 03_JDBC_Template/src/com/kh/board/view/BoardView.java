...
public class BoardView {
	...
	private void insertBoard() {
		...
		if(result > 0) {
			...
			System.out.println("게시글 작성 실패ㅠㅠ");
		}
	}
	...
	private void selectBoard() {
		...
		System.out.println("조회할 게시글번호를 입력해주세요 > ");
		...
		if(board != null) {
			System.out.println("조회하신 게시글 정보입니다.");
			...
			System.out.println("게시글이 삭제되었거나 존재하지 않습니다.");
		}
	...
	public void delete() {
		...
		System.out.println("게시글번호 주세요 > ");
		int boardNo = sc.nextInt();
		sc.nextLine();
		
		int result = bc.delete(boardNo);
		if(result > 0) {
			System.out.println("게시글을 삭제했습니다.");
		} else {
			System.out.println("이미 삭제되었거나 존재하지 않는 게시글입니다.");
		}
	}
