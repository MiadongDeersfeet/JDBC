...
public class JDBCTemplate {
	...
	public static Connection getConnection() {
		try {
			Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@115.90.212.20:10000:XE", "KYK03", "KYK031234");
	...
	// => 다형성을 적용하여 PreparedStatement 객체도 Statement 타입으로 받을 수 있다. (부모↔자식 타입이니까!!!)
